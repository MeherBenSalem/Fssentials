...
public final class MaintenanceConfig {
    ...
    public MaintenanceConfig(DonutEssentialsPlugin plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public synchronized void reload() {
        ...
        this.bypassPermission = config.getString("permissions.bypass", "donutessentials.maintenance.bypass");
        this.notifyPermission = config.getString("permissions.notify", "donutessentials.maintenance.notify");
